...
func TestWorkflow(t *testing.T) {
	testCases := []TestCase{
		...
		{name: "03 check run created", path: "/", event: "check_run", payloadFile: "test/workflow/03_check_run_5834689160_created.json", expCode: http.StatusOK, expContent: ""},
		...
		{name: "05 check run completed", path: "/", event: "check_run", payloadFile: "test/workflow/05_check_run_5834689160_completed.json", expCode: http.StatusOK, expContent: ""},
		...
		{name: "07 check run created", path: "/", event: "check_run", payloadFile: "test/workflow/07_check_run_5834695996_created.json", expCode: http.StatusOK, expContent: ""},
		{name: "08 deployment created", path: "/", event: "deployment", payloadFile: "test/workflow/08_deployment_540578780_created.json", expCode: http.StatusOK, expContent: ""},
		...
		{name: "10 check run created", path: "/", event: "check_run", payloadFile: "test/workflow/10_check_run_5834696229_created.json", expCode: http.StatusOK, expContent: ""},
		...
		{name: "13 deployment status created", path: "/", event: "deployment_status", payloadFile: "test/workflow/13_deployment_status_540578780_created.json", expCode: http.StatusOK, expContent: ""},
		{name: "14 check run completed", path: "/", event: "check_run", payloadFile: "test/workflow/14_check_run_5834695996_completed.json", expCode: http.StatusOK, expContent: ""},
		...
		{name: "17 check run completed", path: "/", event: "check_run", payloadFile: "test/workflow/17_check_run_5834696229_completed.json", expCode: http.StatusOK, expContent: ""},
